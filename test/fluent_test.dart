...
help-menu-save = Click { menu-save } to save the file.''');
	...
	test('your-rank', () {
		FluentBundle bundle = FluentBundle("en-GB");
		bundle.addMessages('''your-rank = { NUMBER(\$pos, type: "ordinal") ->
  ...
  *[other] You finished {\$pos}th
		...
		String translated = bundle.format("your-rank", args: {'pos': 0});
		expect(translated, '''You finished first!''');
		translated = bundle.format("your-rank", args: {'pos': 1});
		expect(translated, '''You finished 1st''');
		translated = bundle.format("your-rank", args: {'pos': 2});
		expect(translated, '''You finished 2nd''');
	});
}
